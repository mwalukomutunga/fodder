const FilterModel = () => {
    return ( 
        <div className="modal fade right-modal" id="exampleModal" tabIndex="-1" role="dialog"
                    ...
                    <div className="osahan-filter">
                        <div className="filter">
                            ...
                            <div className="custom-control border-bottom px-0  custom-radio">
                                ...
                                <label className="custom-control-label py-3 w-100 px-3" htmlFor="customRadio2">Nearest
                                    Me</label>
                            </div>
                            <div className="custom-control border-bottom px-0  custom-radio">
                                <input type="radio" id="customRadio3" name="location" className="custom-control-input"/>
                                <label className="custom-control-label py-3 w-100 px-3" htmlFor="customRadio3">Cost High to
                                    Low</label>
                            </div>
                            <div className="custom-control border-bottom px-0  custom-radio">
                                <input type="radio" id="customRadio4" name="location" className="custom-control-input"/>
                                <label className="custom-control-label py-3 w-100 px-3" htmlFor="customRadio4">Cost Low to
                                    High</label>
                            </div>
                            <div className="custom-control border-bottom px-0  custom-radio">
                                <input type="radio" id="customRadio5" name="location" className="custom-control-input"/>
                                <label className="custom-control-label py-3 w-100 px-3" htmlFor="customRadio5">Most
                                    Popular</label>
                            </div>
                            ...
                            <div className="px-3 pt-3">
                                ...
                                <div className="htmlForm-row">
                                    <div className="htmlForm-group col-6">
                                        <label>Min</label>
                                        <input className="htmlForm-control" placeholder="$0" type="number"/>
                                    </div>
                                    <div className="htmlForm-group text-right col-6">
                                        <label>Max</label>
                                        <input className="htmlForm-control" placeholder="$1,0000" type="number"/>
                                    </div>
                                </div>
                            </div>
                        </div>
